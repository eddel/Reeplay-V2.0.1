                      ...
                      <AppView className="px-5">
                        ...
                        <AppView className="items-center mt-5 px-4">
                          ...
                          <AppText className="text-center mt-2 font-ROBOTO_400 text-white text-xs">
                            2 Sisters set out to Impress the World in a
                            thrilling show of Bravery and Comedic Trickery, the
                            World in a thrilling 2 Sisters set out to Impress
                            the World.
                          </AppText>
                  ...
                  {!addRatting ? (
                    <AppView className="px-5">
                      ...
                      <AppView className="items-center mt-5 px-4">
                        ...
                        <AppText className="text-center mt-2 font-ROBOTO_400 text-white text-xs">
                          2 Sisters set out to Impress the World in a thrilling
                          show of Bravery and Comedic Trickery, the World in a
                          thrilling 2 Sisters set out to Impress the World.
                        </AppText>
